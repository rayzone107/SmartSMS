...
public class StickyHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void fixLayoutSize(ViewGroup parent, View view) {
        ...
        int childWidthSpec = ViewGroup.getChildMeasureSpec(widthSpec, parent.getPaddingLeft() + parent.getPaddingRight(), view.getLayoutParams()
                .width);
        int childHeightSpec = ViewGroup.getChildMeasureSpec(heightSpec, parent.getPaddingTop() + parent.getPaddingBottom(), view.getLayoutParams()
                .height);
    ...
    public interface StickyHeaderInterface {
        ...
        /**
         * This method gets called by {@link StickyHeaderItemDecoration} to get layout resource id for the header item at specified adapter's
         * position.
         *
